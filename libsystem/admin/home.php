    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-light-coral">
            <div class="inner">
              <?php
...
$(function(){
  ...
  barChartData.datasets[1].fillColor   = '#f2c3b9'
  barChartData.datasets[1].strokeColor = '#f2c3b9'
  barChartData.datasets[1].pointColor  = '#f2c3b9'
  var barChartOptions                  = {
