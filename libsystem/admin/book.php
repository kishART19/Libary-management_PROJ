                        ...
                        <tr>
                          ...
                          <td> ";
                              ...
                              if (!empty($row['pdf_file'])) {
                                echo '<a href="view_pdf.php?book_id='.$row['bookid'].'" class="btn btn-info btn-sm" target="_blank">View PDF</a>';
                              } else {
                                echo 'No PDF';
                              }
                             echo"
                          ...
                          <td>
                            ";
                            /*if (!empty($row['pdf_file'])) {
                              // Optional: Only show if status = borrowed
                              if ($row['status']) {
                                echo "<a href='view_pdf.php?book_id=".$row['bookid']."' class='btn btn-info btn-sm' target='_blank'>View PDF</a>";
                              } else {
                                echo "<em>Only for borrowers</em>";
                              }
                            } else {
                              echo "No PDF";
                            }*/
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#edit_pdf_file"').val(response.publish_date);
